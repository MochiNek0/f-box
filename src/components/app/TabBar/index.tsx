...
export const TabBar: React.FC = () => {
  ...
  return (
    <div className="flex bg-background border-b border-border items-end h-gr-5 min-w-0">
      <div className="flex items-end px-gr-3 gap-gr-2 h-full overflow-x-auto no-scrollbar flex-1 min-w-0">
        {tabs.map((tab) => (
          <div
            key={tab.id}
        ...
        <IconButton
          icon={<Plus size={16} />}
          onClick={addTab}
          className="mb-0 ml-gr-1 self-center flex-shrink-0"
        />
      </div>
